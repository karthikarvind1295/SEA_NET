...
def attention(x, channels, scope='attention'):
    ...
    f = tf.keras.layers.Conv2D(channels // 8 , kernel_size=1, strides=1, kernel_initializer='glorot_uniform', name='f_conv')(x) # [bs, h, w, c'] 
    g = tf.keras.layers.Conv2D(channels // 8 , kernel_size=1, strides=1, kernel_initializer='glorot_uniform', name='g_conv')(x) # [bs, h, w, c']
    ...
    o = tf.keras.layers.Conv2D(channels , kernel_size=1, strides=1, kernel_initializer='glorot_uniform', name='attn_conv')(o)
...
def ResNet43_8s_Attn(input_shape,  # pylint: disable=invalid-name
  ...
  x = attention(x, 512) #Attention in ResNet
